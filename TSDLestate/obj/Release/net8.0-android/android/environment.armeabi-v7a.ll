...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 421196140, ; hash 0x191af16c, from name: libaot-TSDLestate.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2492222864, ; hash 0x948c4d90, from name: aot-TSDLestate
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 347
	...
	%struct.DSOCacheEntry {
		i64 2718632263, ; hash 0xa20b0947, from name: TSDLestate
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 378
	...
	%struct.DSOCacheEntry {
		i64 2838661432, ; hash 0xa9328938, from name: libaot-TSDLestate
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 398
	...
	%struct.DSOCacheEntry {
		i64 2993745166, ; hash 0xb270ed0e, from name: aot-TSDLestate.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 422
	...
	%struct.DSOCacheEntry {
		i64 3449244706, ; hash 0xcd974c22, from name: TSDLestate.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
