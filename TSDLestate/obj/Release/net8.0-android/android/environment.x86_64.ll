...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2200073561816611182, ; hash 0x1e883b3f7bceb96e, from name: aot-TSDLestate
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3793886568205643642, ; hash 0x34a697bba005ef7a, from name: TSDLestate.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 120
	%struct.DSOCacheEntry {
		i64 3914864860693163739, ; hash 0x365464d955466edb, from name: libaot-TSDLestate.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 8080363064710345567, ; hash 0x70233765503f335f, from name: TSDLestate
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 9359262043241636636, ; hash 0x81e2c73da736e31c, from name: libaot-TSDLestate
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 291
	...
	%struct.DSOCacheEntry {
		i64 17237916531531234342, ; hash 0xef3961c149c0bc26, from name: aot-TSDLestate.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TSDLestate.dll.so
		ptr null; void* handle (0x0)
	}, ; 541
...
@.env.3 = private unnamed_addr constant [37 x i8] c"8e1edfe6-2cda-43fe-a9af-fc6104c21fda\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [16 x i8] c"lestate.lestate\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-TSDLestate.dll.so\00", align 16
